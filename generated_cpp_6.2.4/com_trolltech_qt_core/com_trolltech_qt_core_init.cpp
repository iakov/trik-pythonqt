...
PythonQt::priv()->registerCPPClass("QAbstractListModel", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QAbstractListModel>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QAbstractListModel>, module, 0);
PythonQt::priv()->registerCPPClass("QApplicationStateChangeEvent", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QApplicationStateChangeEvent>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QApplicationStateChangeEvent>, module, 0);
...
PythonQt::priv()->registerCPPClass("QChildEvent", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QChildEvent>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QChildEvent>, module, 0);
...
PythonQt::priv()->registerCPPClass("QDeferredDeleteEvent", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QDeferredDeleteEvent>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QDeferredDeleteEvent>, module, 0);
PythonQt::priv()->registerCPPClass("QDirIterator", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QDirIterator>, NULL, module, 0);
PythonQt::priv()->registerCPPClass("QDynamicPropertyChangeEvent", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QDynamicPropertyChangeEvent>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QDynamicPropertyChangeEvent>, module, 0);
...
PythonQt::priv()->registerCPPClass("QOperatingSystemVersion", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QOperatingSystemVersion>, NULL, module, 0);
...
PythonQt::priv()->registerCPPClass("QSemaphore", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QSemaphore>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QSemaphore>, module, 0);
...
PythonQt::priv()->registerCPPClass("QSystemSemaphore", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QSystemSemaphore>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QSystemSemaphore>, module, 0);
...
PythonQt::priv()->registerCPPClass("QTimerEvent", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QTimerEvent>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QTimerEvent>, module, 0);
